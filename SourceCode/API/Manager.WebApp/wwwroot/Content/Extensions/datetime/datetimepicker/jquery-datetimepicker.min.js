	...
	$.fn.datetimepicker = function( opt ){
		...
		var default_options  = {
			i18n:{
				ru:{
					months:[
						'Đ¯Đ½Đ²Đ°Ñ€ÑŒ','Đ¤ĐµĐ²Ñ€Đ°Đ»ÑŒ','ĐœĐ°Ñ€Ñ‚','ĐĐ¿Ñ€ĐµĐ»ÑŒ','ĐœĐ°Đ¹','Đ˜ÑĐ½ÑŒ','Đ˜ÑĐ»ÑŒ','ĐĐ²Đ³ÑƒÑÑ‚','Đ¡ĐµĐ½Ñ‚ÑĐ±Ñ€ÑŒ','ĐĐºÑ‚ÑĐ±Ñ€ÑŒ','ĐĐ¾ÑĐ±Ñ€ÑŒ','Đ”ĐµĐºĐ°Đ±Ñ€ÑŒ'
					],
					dayOfWeek:[
						"Đ’ÑĐº", "ĐŸĐ½", "Đ’Ñ‚", "Đ¡Ñ€", "Đ§Ñ‚", "ĐŸÑ‚", "Đ¡Đ±"
					]
				},
				en:{
					months: [
		...
		var CreatedDateTimePicker = function( input ){
		...
		return this.each(function(){
			...
			if( datetimepicker = $(this).data('xdsoft_datetimepicker') ){
				...
				($.type(opt) !== 'string')&&CreatedDateTimePicker($(this));
		});
	};
})( jQuery );
